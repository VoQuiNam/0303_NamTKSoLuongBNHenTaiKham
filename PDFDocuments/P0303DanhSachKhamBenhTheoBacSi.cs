...
{
    public class P0303DanhSachKhamBenhTheoBacSi : IDocument
    {
        private readonly List<M0303DanhSachKhamBenhTheoBacSiSTO> _data;
            ...
            container.Page(page =>
            {
                ...
                page.Header().ShowOnce().Column(headerCol =>
                {
                    headerCol.Item().Row(row =>
                    {
                        ...
                        row.RelativeColumn().Column(col =>
                        {
                            col.Item().AlignRight().Text("DANH SÁCH KHÁM BỆNH THEO BÁC SĨ")
                    ...
                    contentCol.Item().Table(table =>
                    {
                        ...
                        foreach (var bacSiGroup in groupedByBacSi)
                        {
                            ...
                            foreach (var item in patients)
                            {
                                ...
                                AddDataCell(item.HoTenBenhNhan ?? ""); // Họ tên bệnh nhân
